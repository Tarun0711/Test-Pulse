...
export default function Profile() {
  ...
  return (
    <button ref={ref} className="relative border-2 transition-all ease-in-out duration-300 px-1 border-richblack-300  p-[3px] rounded-full " onClick={toggleOpen}>
      ...
      {open && (
        <div onClick={(e) => e.stopPropagation()}  ref = {ref}  className=" px-16 py-4  top-[118%]  right-0 z-[1000] divide-y-[1px] divide-richblue-300 text-richblack-100 overflow-hidden rounded-md border-[1px] border-richblack-700 bg-richblue-800 " >
