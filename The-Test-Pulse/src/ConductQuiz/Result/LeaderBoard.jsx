...
import './Leaderboard.css'; // Assuming you have the styles defined in a separate CSS file
    ...
    <article className="leaderboard">
      <header>
        ...
        <h1 className="leaderboard__title">
          <span className="leaderboard__title--top">The Test Pulse</span>
      ...
      <main className="leaderboard__profiles">
        {profiles.map((profile, index) => (
          <article key={index} className="leaderboard__profile">
            <img src={profile.imgSrc} alt={profile.name} className="leaderboard__picture" />
            <span className="leaderboard__name">{profile.name}</span>
            <span className="leaderboard__value">{profile.value}</span>
          </article>
        ))}
      </main>
    </article>
